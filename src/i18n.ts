...
const ko: Dict = {
  ...
  "Recent rooms": "최근 협업 방", "Move to canvas…": "다른 캔버스로 이동…", "Move to canvas": "다른 캔버스로 이동", "+ A new canvas": "+ 새 캔버스", " elements will move. Undo brings them back.": "개를 옮깁니다. 실행 취소로 되돌릴 수 있습니다.", "Recent rooms…": "최근 협업 방…", "Copy link": "링크 복사", "No rooms visited from this browser yet.": "이 브라우저에서 방문한 방이 없습니다.", "Rooms are relayed, not stored. This list lives in this browser only.": "방은 중계만 되고 서버에 저장되지 않습니다. 이 목록은 이 브라우저에만 있습니다.", "Remove from this list — the room itself is unaffected": "목록에서 제거 — 방 자체는 그대로입니다",
  "Nothing to find": "찾을 요소가 없습니다", "Find drawings": "그림 찾기", "elements": "개", "No separate drawings": "떨어진 그림이 없습니다",
  "Fitted your drawing — press again to fit everyone's": "내 그림에 맞췄습니다 — 다시 누르면 전체에 맞춥니다",
...
const ja: Dict = {
  ...
  "Recent rooms": "最近のルーム", "Move to canvas…": "別のキャンバスへ移動…", "Move to canvas": "別のキャンバスへ移動", "+ A new canvas": "+ 新しいキャンバス", " elements will move. Undo brings them back.": "個を移動します。取り消しで戻せます。", "Recent rooms…": "最近のルーム…", "Copy link": "リンクをコピー", "No rooms visited from this browser yet.": "このブラウザで訪れたルームはありません。", "Rooms are relayed, not stored. This list lives in this browser only.": "ルームは中継されるだけで保存されません。この一覧はこのブラウザのみに存在します。", "Remove from this list — the room itself is unaffected": "一覧から削除 — ルーム自体はそのままです",
  "Nothing to find": "見つかる要素がありません", "Find drawings": "図を探す", "elements": "個", "No separate drawings": "離れた図はありません",
  "Fitted your drawing — press again to fit everyone's": "自分の図に合わせました — もう一度押すと全体に合わせます",
...
const zh: Dict = {
  ...
  "Recent rooms": "最近的房间", "Move to canvas…": "移动到其他画布…", "Move to canvas": "移动到其他画布", "+ A new canvas": "+ 新画布", " elements will move. Undo brings them back.": "个元素将被移动。可撤销。", "Recent rooms…": "最近的房间…", "Copy link": "复制链接", "No rooms visited from this browser yet.": "此浏览器尚未访问过任何房间。", "Rooms are relayed, not stored. This list lives in this browser only.": "房间只做中转，不会被保存。此列表仅存在于本浏览器中。", "Remove from this list — the room itself is unaffected": "从列表中移除 — 房间本身不受影响",
  "Nothing to find": "没有可查找的元素", "Find drawings": "查找图形", "elements": "个", "No separate drawings": "没有分散的图形",
  "Fitted your drawing — press again to fit everyone's": "已适配你的图形 — 再按一次适配全部",
...
const fr: Dict = {
  ...
  "Recent rooms": "Salles récentes", "Move to canvas…": "Déplacer vers un canevas…", "Move to canvas": "Déplacer vers un canevas", "+ A new canvas": "+ Nouveau canevas", " elements will move. Undo brings them back.": " éléments seront déplacés. Annuler les ramène.", "Recent rooms…": "Salles récentes…", "Copy link": "Copier le lien", "No rooms visited from this browser yet.": "Aucune salle visitée depuis ce navigateur.", "Rooms are relayed, not stored. This list lives in this browser only.": "Les salles sont relayées, pas stockées. Cette liste n'existe que dans ce navigateur.", "Remove from this list — the room itself is unaffected": "Retirer de cette liste — la salle n'est pas affectée",
  "Nothing to find": "Rien à trouver", "Find drawings": "Trouver les dessins", "elements": "éléments", "No separate drawings": "Aucun dessin séparé",
  "Fitted your drawing — press again to fit everyone's": "Ajusté à votre dessin — appuyez encore pour tout ajuster",
