...
const ko: Dict = {
  ...
  "Recent rooms": "최근 협업 방", "Recent rooms…": "최근 협업 방…", "Copy link": "링크 복사", "No rooms visited from this browser yet.": "이 브라우저에서 방문한 방이 없습니다.", "Rooms are relayed, not stored. This list lives in this browser only.": "방은 중계만 되고 서버에 저장되지 않습니다. 이 목록은 이 브라우저에만 있습니다.", "Remove from this list — the room itself is unaffected": "목록에서 제거 — 방 자체는 그대로입니다",
...
const ja: Dict = {
  ...
  "Recent rooms": "最近のルーム", "Recent rooms…": "最近のルーム…", "Copy link": "リンクをコピー", "No rooms visited from this browser yet.": "このブラウザで訪れたルームはありません。", "Rooms are relayed, not stored. This list lives in this browser only.": "ルームは中継されるだけで保存されません。この一覧はこのブラウザのみに存在します。", "Remove from this list — the room itself is unaffected": "一覧から削除 — ルーム自体はそのままです",
...
const zh: Dict = {
  ...
  "Recent rooms": "最近的房间", "Recent rooms…": "最近的房间…", "Copy link": "复制链接", "No rooms visited from this browser yet.": "此浏览器尚未访问过任何房间。", "Rooms are relayed, not stored. This list lives in this browser only.": "房间只做中转，不会被保存。此列表仅存在于本浏览器中。", "Remove from this list — the room itself is unaffected": "从列表中移除 — 房间本身不受影响",
