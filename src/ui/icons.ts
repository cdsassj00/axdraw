...
export const icons: Record<string, string> = {
  ...
  template: wrap('<rect x="3.5" y="3.5" width="7.5" height="7.5" rx="1.5"/><rect x="13" y="3.5" width="7.5" height="7.5" rx="1.5"/><rect x="3.5" y="13" width="7.5" height="7.5" rx="1.5"/><rect x="13" y="13" width="7.5" height="7.5" rx="1.5"/>'),
  users: wrap('<circle cx="9" cy="8" r="3.5"/><path d="M3.5 20a5.5 5.5 0 0 1 11 0"/><path d="M15.5 5a3.5 3.5 0 0 1 0 6.3"/><path d="M17 14.6a5.5 5.5 0 0 1 3.5 5.4"/>'),
  ...
  /* Z-order: plain arrows read instantly — a bar means "all the way". */
  sendToBack: wrap('<path d="M5 19.5h14"/><path d="M12 4.5V15"/><path d="M8 11.5l4 4 4-4"/>'),
  bringToFront: wrap('<path d="M5 4.5h14"/><path d="M12 19.5V9"/><path d="M8 12.5l4-4 4 4"/>'),
  sendBackward: wrap('<path d="M12 5v14"/><path d="M7.5 14.5 12 19l4.5-4.5"/>'),
  bringForward: wrap('<path d="M12 19V5"/><path d="M7.5 9.5 12 5l4.5 4.5"/>'),
